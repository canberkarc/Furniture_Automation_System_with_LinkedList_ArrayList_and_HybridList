...
public class Company{
	...
	/**
	* This static linked list in type Branch is the branches' list
	*/
	protected static KWLinkedList<Branch> branchList = new KWLinkedList<Branch>();
	/**
	* This static array list in type BranchEmployee is the employees' list
	*/
	protected static KWArrayList<BranchEmployee> employeeList = new KWArrayList<BranchEmployee>();
	/**
	* This static array list in type Furniture is the customers' list
	*/
	protected static KWArrayList<Customer> customerList = new KWArrayList<Customer>();
	/**
	* This static hybrid list in type Furniture is the furnitures' list
	*/
	...
	*/
	...
	/**
	 * This method gives linked list of Branch objects.
	...
	/**
	 * This method gives array list of BranchEmployee objects.
	...
	/**
	 * This method gives hybrid list of Furniture objects.
	...
	/**
	 * This method gives array list of Customer objects.
	...
	/**
	 * That method prints the branches.
	 */
	...
	public boolean showCustomers(){
		...
		if(customerList.size() > 0){	
			...
			for(int i=0; i<customerList.size(); i++){
				...
				str += "\n";
				str = str + "Surname: " + customerList.get(i).getCustomerNumber();
				str += "\n";
			str += "\n\n";
			}
		}
	...
	/**
	 * That method prints the employees.
	 */
